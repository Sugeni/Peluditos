 ...
 * @author Efigenia
 */
public class VistaEspecialidad extends VistaModelo {
    String cedula;
    String nombre;
    int permisos;
     ...
     * @param padre
     */
    public VistaEspecialidad(JFrame padre ) {
        super( padre );
        ...
        public VistaEspecialidad(JFrame padre, String cedula,int permisos,String nombre ) {
        super( padre );
        this.setVisible(false);
        this.cedula= cedula;
        this.nombre= nombre;
    ...
    protected void actualizarR(){
       ...
       if(editar){ 
        ...
        if ( (! ( (tfNombre.getText().equals("Ingrese el Nombre") ) || (tfNombre.getText().equals("") ) ) )
             ...
             ConsultasBD.modificarEspecialidad(tfNombre.getText(), dato);
             mostrarR();
    ...
    protected void crearR(){
         if ( ! ( (tfNombre.getText().equals("Ingrese el Nombre") ) || (tfNombre.getText().equals("") || ConsultasBD.existeEspecialidad(tfNombre.getText()) ) ) ){
            ConsultasBD.agregarEspecialidad( tfNombre.getText() );
    ...
    protected void mostrarR(){
        ...
        datos = ConsultasBD.obtenerEspecialidades();
    ...
    protected void buscarR(){
        ...
        String respuesta = JOptionPane.showInputDialog( "Inserte el nombre de la especialidad a buscar");
         if ( ! ( (respuesta.trim().equals("") ) || (editar) 
                   || editar) & ConsultasBD.existeEspecialidad(respuesta.trim() ) ) {
             
             editar = true;
             dato =  respuesta;
             Especialidad p = ConsultasBD.buscarEspecialidad(dato).get(0);
    ...
    protected void borrarR(){
        ...
        String respuesta = JOptionPane.showInputDialog( "Inserte el nombre del servicio a borrar");
         if ( ! ((respuesta.trim().equals("") ) ) 
             ...
             if( i == 0){
              ConsultasBD.borrarEspecialidad( respuesta ) ;
              mostrarR();
             }
        }    
        else
    ...
    private void initComponents() {
        ...
        Txt_Infor.setText("Especialidades");
        ...
        jp_BarraHerramientasLayout.setHorizontalGroup(
            ...
            .addGroup(jp_BarraHerramientasLayout.createSequentialGroup()
                ...
                .addComponent(Txt_user, javax.swing.GroupLayout.PREFERRED_SIZE, 455, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        tfNombre.setBounds(180, 30, 220, 30);

        jPanel1.add(panelFormulario);
        panelFormulario.setBounds(30, 150, 440, 190);
    ...
    protected javax.swing.JLabel Txt_user;
